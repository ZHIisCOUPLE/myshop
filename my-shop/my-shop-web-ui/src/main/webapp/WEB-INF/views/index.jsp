...
<div id="lunbo">
    <ul id="one">
        <c:forEach items="${slideShow}" var="pic" >
        <li><a href=""><img src="http://localhost:8080/content/picShow?fileName=${pic}"></a></li>
        </c:forEach>
    </ul>
    <ul id="two">
        <c:forEach items="${slideShow}" varStatus="status">
